jQuery(document).ready(function() {
	if ($('.beforeafter').size() > 0) {
		loadScript('http://static.salesforcedemos.com/beforeafter/js/jquery-ui-1.8.23.custom.min.js', loadBeforeAfterScript);
	}
});
...
function renderBeforeAfter(container) {
	...
	$(container).beforeAfter({
		animateIntro:true,
		imagePath:'http://static.salesforcedemos.com/beforeafter/img/',
		introDuration : 600,
		introPosition : .4,
		showFullLinks : true,
